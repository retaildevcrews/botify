...
openai_api_version = get_env_var(
    "AZURE_OPENAI_API_VERSION", default_value="2024-04-01-preview", required=False
)
...
if speech_engine == "azure":
    ...
    azure_speech_voice_name = get_env_var(
        "AZURE_SPEECH_VOICE_NAME", default_value="en-US-AriaNeural", required=False
    )
