...
class TestStringMethods(unittest.TestCase):
    def test_secrets_dont_print(self):
        ...
        self.assertEqual(
            str(app_settings.environment_config.azure_search_key), "**********")
        self.assertEqual(
            str(app_settings.environment_config.content_safety_key), "**********")
        self.assertEqual(
            str(app_settings.environment_config.openai_api_key), "**********")
        self.assertEqual(
            str(app_settings.environment_config.cosmos_connection_string), "**********")
    ...
    def test_app_settings_full(self):
        ...
        self.assertEqual(app_settings.environment_config.openai_api_version,
                         "2024-04-01-preview")
        self.assertEqual(
            app_settings.environment_config.openai_endpoint, "https://localhost:8081")
        self.assertEqual(
            app_settings.environment_config.openai_api_key.get_secret_value(), "key")
        self.assertEqual(
            app_settings.environment_config.openai_deployment_name, "model_name")
        self.assertEqual(
            app_settings.environment_config.cosmos_endpoint, "https://localhost:8081")
        self.assertEqual(
            app_settings.environment_config.cosmos_database, "database")
        self.assertEqual(
            app_settings.environment_config.cosmos_container, "container")
        self.assertEqual(
            app_settings.environment_config.cosmos_connection_string.get_secret_value(), "connection_string")
        self.assertEqual(
            app_settings.environment_config.azure_search_endpoint, "https://localhost:8081")
        self.assertEqual(
            app_settings.environment_config.azure_search_key.get_secret_value(), "key")
        self.assertEqual(
            app_settings.environment_config.azure_search_api_version, "api_version")
        self.assertEqual(
            app_settings.environment_config.doc_index, "index_name")
        self.assertEqual(
            app_settings.environment_config.content_safety_endpoint, "DEBUG")
        self.assertEqual(
            app_settings.environment_config.content_safety_key.get_secret_value(), "key")
