...
schema = """{"title":"Example Schema","type":"object",
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_escape_curly_braces(self):
        ...
        expected_string = """{{"title":"Example Schema","type":"object",
        "properties":{{"firstName":{{"type":"string"}},"lastName":{{"type":"string"}},
        "age":{{"description":"Age in years","type":"integer","minimum":0}}}},
        "required":["firstName","lastName"]}}"""
    ...
    def test_generate_jinja_prompt(self):
        ...
        prompt = prompt_gen.generate_prompt(jinja_template_name, json_schema=schema)
        self.assertIsNotNone(prompt)

    def test_generate_text_prompt(self):
        prompt_gen = PromptGen()
        template_name = "minified_json.txt"
        prompt = prompt_gen.generate_prompt(template_name=template_name, json_schema=schema)
        self.assertIsNotNone(prompt)
