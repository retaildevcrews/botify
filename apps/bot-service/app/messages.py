...
CHARACTER_LIMIT_ERROR_MESSAGE_JSON = {
    "displayResponse": CHARACTER_LIMIT_ERROR_MESSAGE,
    "voiceSummary": CHARACTER_LIMIT_ERROR_MESSAGE,
}

MAX_TURNS_EXCEEDED_ERROR_MESSAGE = """I'm sorry, unfortunately I am unable to continue this conversation.
You have exceeded the maximum number of questions I am allowed to answer."""
MAX_TURNS_EXCEEDED_ERROR_MESSAGE_JSON = {
    "displayResponse": MAX_TURNS_EXCEEDED_ERROR_MESSAGE,
    "voiceSummary": MAX_TURNS_EXCEEDED_ERROR_MESSAGE,
}
