...
GENERIC_ERROR_MESSAGE_JSON = {
    "displayResponse": GENERIC_ERROR_MESSAGE,
    "voiceSummary": GENERIC_ERROR_MESSAGE
}

SAFETY_ERROR_MESSAGE = "I'm sorry, I can't answer that question. Please ask something else."
SAFETY_ERROR_MESSAGE_JSON = {
    "displayResponse": SAFETY_ERROR_MESSAGE,
    "voiceSummary": SAFETY_ERROR_MESSAGE
}
