using 'azuredeploy-backend-private.bicep'
...
param appConfigurationValues = [
  ...
  'AZURE_OPENAI_MODEL_NAME=${readEnvironmentVariable('AZURE_OPENAI_MODEL_NAME', 'gpt-4o')}'
  'CONTENT_SAFETY_ENDPOINT=${readEnvironmentVariable('CONTENT_SAFETY_ENDPOINT', '')}'
  'OPEN_TELEMETRY_COLLECTOR_ENDPOINT=${readEnvironmentVariable('OPEN_TELEMETRY_COLLECTOR_ENDPOINT', 'https://app-collector-${resourceNameSuffix}-001.azurewebsites.net:443')}'
]
...
param frontDoorEndpointState = 'Enabled'
//param frontDoorEndpointName string = 'backend'
