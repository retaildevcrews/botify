...
class _AsyncBotBehaviorEvaluator:
    ...
    async def __call__(self, *, question: str, answer: str, expected_behavior: str, **kwargs):
        try:
            ...
            llm_output = await self._flow(question=question, answer=answer, expected_behavior=expected_behavior, timeout=self.LLM_CALL_TIMEOUT, **kwargs)
...
class BotBehaviorEvaluator:
    ...
    def __call__(self, *, question: str, answer: str, expected_behavior: str, **kwargs):
        ...
        """
        return async_run_allowing_running_loop(self._async_evaluator, question=question, answer=answer, expected_behavior=expected_behavior, **kwargs)
