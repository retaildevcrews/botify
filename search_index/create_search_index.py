        ...
        "vectorSearch": {
            "algorithms": [  # We are showing here 3 types of search algorithms configurations that you can do
                ...
                },
                {
                    ...
                    "kind": "hnsw",
                    "hnswParameters": {"m": 8, "efConstruction": 800, "efSearch": 800, "metric": "cosine"},
                },
                {
                    "name": "my-eknn-config",
                    "kind": "exhaustiveKnn",
            ...
            "profiles": [  # profiles is the diferent kind of combinations of algos and vectorizers
                {"name": "my-vector-profile-1", "algorithm": "my-hnsw-config-1", "vectorizer": "openai"},
                {"name": "my-vector-profile-2", "algorithm": "my-hnsw-config-2", "vectorizer": "openai"},
                {"name": "my-vector-profile-3", "algorithm": "my-eknn-config", "vectorizer": "openai"},
            ],
        },
        "semantic": {
            "configurations": [
    ...
    skillset_payload = {
        ...
        "skills": [
            ...
            },
            {
                ...
                "description": """Create merged_text, which includes all the textual representation
                                  of each image inserted at the right location in the content field.
                                  This is useful for PDF and other file formats that supported
                                  embedded images.""",
                "context": "/document",
                "insertPreTag": " ",
                "insertPostTag": " ",
            ...
            },
            {
                ...
                "context": "/document",
                "textSplitMode": "pages",  # although it says "pages", it means chunks not actual pages
...
if __name__ == "__main__":
    ...
    if not create_skillset():
        exit(1)
    if not create_blob_container_datasource():
        exit(1)
